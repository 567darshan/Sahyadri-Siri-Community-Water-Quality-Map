...
public class SubmitHistoricalReportInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (location.getText().toString().equals("")) {
                    ...
                    alertMessage(
                            "Blank Fields",
                            "Location field is empty. Please fill in all fields."
                    );

                } else {

                    Intent i = new Intent(
                            SubmitHistoricalReportInfo.this,
                            WaterQualityHistoryGraphActivity.class
                    );
        ...
        /**
         * If cancel button is clicked, goes back.
         */
